                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="col-xl-4">
                        <div class="form-group">
                          ...
                          <label class="custom-file">
                              <img src="{{ URL::to($product->image_one)}}" style="height: 200px; wigth: 200px;">
                      ...
                      <div class="col-xl-4">
                        <div class="form-group">
                          ...
                          <label class="custom-file">
                            <img src="{{ URL::to($product->image_two)}}" style="height: 200px; wigth: 200px;">
                          </label>
                        </div>
                      </div><!-- col-4 -->
                      ...
                      <div class="col-xl-4">
                         <div class="form-group">
                          ...
                          <label class="custom-file">
                            <img src="{{ URL::to($product->image_three)}}" style="height: 200px; wigth: 200px;">
                          </label>
                          </div>
                      </div><!-- col-4 -->
