...
Route::get('remove/cart/{rowId}', 'CartController@remoneCart');
Route::post('update/cart/item', 'CartController@UpdateCart')->name('update.cartitem');

Route::get('/cart/product/view/{id}', 'CartController@ViewProduct');
Route::post('insert/into/cart/', 'CartController@insertCart')->name('insert.into.cart');

Route::get('user/chekcout/', 'CartController@Checkout')->name('user.checkout');
...
// order traking route
Route::post('order/traking', 'FrontController@OrderTraking')->name('order.traking');
...
Route::post('admin/sitesetting', 'Admin\SettingController@UpdateSiteSetting')->name('admin.update.sitesetting');
...
Route::get('admin/all/return/', 'Admin\ReturnController@AllReturn')->name('admin.all.request');
